...
<td>{{ isset($row->categories->country) ? $row->categories->country : '' }}</td>
<td>{{ isset($row->categories->price) ? $row->categories->price : '' }}</td>
<td>{{ isset($row->categories->dateOfEvent) ? $row->categories->dateOfEvent : '' }}</td>
